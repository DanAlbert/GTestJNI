...
Java_com_android_gtestjni_GtestRunner_nInitialize(JNIEnv *env, jclass, jobject suite) {
...
Java_com_android_gtestjni_GtestRunner_nRun(JNIEnv *env, jclass, jobject notifier) {
    auto& listeners = ::testing::UnitTest::GetInstance()->listeners();
